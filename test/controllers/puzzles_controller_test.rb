...
class PuzzlesControllerTest < ActionController::TestCase
  ...
  test "should create puzzle" do
    assert_difference('Puzzle.count') do
      post :create, puzzle: { content: @puzzle.content, name: @puzzle.name, type: @puzzle.type, winrules: @puzzle.winrules }
    end
  ...
  test "should update puzzle" do
    patch :update, id: @puzzle, puzzle: { content: @puzzle.content, name: @puzzle.name, type: @puzzle.type, winrules: @puzzle.winrules }
    assert_redirected_to puzzle_path(assigns(:puzzle))
  end
