...
class IncentivesControllerTest < ActionController::TestCase
  ...
  test "should create incentive" do
    assert_difference('Incentive.count') do
      post :create, incentive: { code: @incentive.code, expirydate: @incentive.expirydate, title: @incentive.title }
    end
  ...
  test "should update incentive" do
    patch :update, id: @incentive, incentive: { code: @incentive.code, expirydate: @incentive.expirydate, title: @incentive.title }
    assert_redirected_to incentive_path(assigns(:incentive))
  end
