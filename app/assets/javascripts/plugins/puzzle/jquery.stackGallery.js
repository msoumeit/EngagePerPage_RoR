...
(function($) {
	...
	if(slideshowOn){
		controls_toggle.find('img').attr('src', '/assets/icons/pause.png');
	}else{
		controls_toggle.find('img').attr('src', '/assets/icons/play.png');
	}
	...
	function setup(){	
		...
		for(i; i <playlistLength; i++){
			...
			div.find('a[class=pp_content]').bind('click', function(){
				...
				$(this).find('img').attr('src', '/assets/icons/detail_on.png');
				return false;
			}).bind('mouseout', function(){
				$(this).find('img').attr('src', '/assets/icons/detail.png');
				return false;
			});
			
			div.find('a[class=pp_link]').bind('mouseover', function(){
				$(this).find('img').attr('src', '/assets/icons/link_on.png');
				return false;
			}).bind('mouseout', function(){
				$(this).find('img').attr('src', '/assets/icons/link.png');
				return false;
			});
	...
	function overControls(e){
		...
		if(c == "controls_previous"){
			img.attr('src', '/assets/icons/prev_on.png');
		}else if(c == "controls_toggle"){
			if(slideshowOn){
				img.attr('src', '/assets/icons/pause_on.png');
			}else{
				img.attr('src', '/assets/icons/play_on.png');
			}	
		}else if(c == "controls_next"){
			img.attr('src', '/assets/icons/next_on.png');
		}
		return false;
	}
	...
	function outControls(e){
		...
		if(c == "controls_previous"){
			img.attr('src', '/assets/icons/prev.png');
		}else if(c == "controls_toggle"){
			if(slideshowOn){
				img.attr('src', '/assets/icons/pause.png');
			}else{
				img.attr('src', '/assets/icons/play.png');
			}	
		}else if(c == "controls_next"){
			img.attr('src', '/assets/icons/next.png');
		}
		return false;
	}
